# Generated by Powerlevel10k configuration wizard on 2025-05-19 at 11:03 -03.
...
# slanted separators, round heads, slanted tails, 1 line, sparse, few icons, concise,
...
() {
  ...
  #####################################[ vcs: git status ]######################################
  # Disable gitstatus daemon in this environment because it fails during shell startup with:
  # `setopt: can't change option: monitor`.
  # Powerlevel10k will fall back to standard vcs integration instead of crashing.
